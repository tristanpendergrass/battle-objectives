...
renderTopSection =
    div []
        ...
        , p [] [ text "How to use:" ]
        , ol []
            [ li [] [ span [ class "emphasize" ] [ text "Decide" ], span [] [ text " with your group on any suitable seed (e.g. 'myseed1234') and which player is which number." ] ]
            , li [] [ span [ class "emphasize" ] [ text "Enter" ], span [] [ text " the seed in the box below and then click the 'Show' button for your number." ] ]
            , li [] [ span [] [ text "(optional) " ], span [ class "emphasize" ] [ text "Share" ], span [] [ text " the seed with the other players in your group. They can enter it on their own device to see identical results." ] ]
            ]
        ]
